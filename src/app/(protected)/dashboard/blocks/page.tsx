...
export default function Blocks() {
  return (
    <div className="bg-muted/40 flex min-h-screen w-full flex-col">
      {/* <aside className="fixed inset-y-0 left-0 z-10 flex w-24 flex-col border-r bg-background sm:hidden">
        <nav className="flex flex-col items-center gap-4 px-2 sm:py-5">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Link
                href="#"
                className="text-accent-foreground flex h-9 w-9 items-center justify-center rounded-lg bg-accent transition-colors hover:text-foreground md:h-8 md:w-8"
              >
      ...
      <div className="flex flex-col gap-4 ">
        <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6">
          ...
          <div className="relative ml-auto flex-1 md:grow-0">
            ...
            <Input
              type="search"
              placeholder="Search..."
              className="w-full rounded-lg bg-background pl-8 lg:w-[336px] md:w-[200px]"
            />
          </div>
          <DropdownMenu>
        ...
        <main className="grid flex-1 grid-cols-4 items-start gap-4 p-4 px-6 py-0">
          <div className="col-span-3 grid auto-rows-max items-start gap-4 ">
            <div className="grid grid-cols-3 gap-4 sm:grid-cols-1">
              <Card className="" x-chunk="dashboard-05-chunk-0">
                ...
                <CardFooter>
                  <Button className="text-background">Create New Order</Button>
                </CardFooter>
              </Card>
              ...
              <CardHeader className="bg-muted/50 flex flex-row items-start">
                ...
                <div className="ml-auto flex items-center gap-1">
                  <Button size="sm" variant="outline" className="h-8 gap-1">
                    ...
                    <span className="xl:not-sr-only xl:whitespace-nowrap lg:sr-only">
                      Track Order
                    </span>
                  </Button>
                  <DropdownMenu>
